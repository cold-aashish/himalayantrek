...
import nepalTourPackageData from "../../data/nepalTourPackageData";
import isTextMatched from "../../utils/isTextMatched";
import TourPagination from "@/components/tour-package/TourPagination";

const NepalTourPackage = () => {
    ...
    return (
        <>
                ...
                {nepalTourPackageData.slice(0,8).map((item) => (
                                ...
                                <div className="activityCard__content custom-card-type-2">
                                    ...
                                    <div className="col-auto border-bottom mb-5">
                                        <div className="">
                                            ...
                                            <div
                                                className="text-14 text-light-1 d-flex align-items-center justify-between">
                                    ...
                                    <div className="row justify-between items-center pt-10">
                                        ...
                                        <div className="col-auto">
                                            <div className="text-14  fw-600">
                                                <i className="icon-clock text-15 me-1">
                                                </i>
                                                {item?.days}
                                            </div>
                                        </div>
...
export default NepalTourPackage;
