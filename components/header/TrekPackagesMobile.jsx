...
import { categorieMegaMenuItemsNepal } from "../../data/mainMenuData";
import {
    isActiveParent,
    isActiveLink,
...
const TrekPackages = ({setIsActiveParent}) => {
        ...
        <div className="tabs -underline-2 js-tabs">
            ...
            <div className="tabs__content js-tabs-content bg-blue-3 p-2">
                ...
                <div className={'react-tabs__tab-panel--selected'}>
                    {categorieMegaMenuItemsNepal[activeNestedMenu]?.menuCol?.map((megaCol, i) => (
