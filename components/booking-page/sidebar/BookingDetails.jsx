...
const BookingDetails = () => {
  return (
    <div className="px-30 py-30 border-light rounded-4">
      ...
      <div className="row x-gap-15 y-gap-20">
        ...
        <div className="col">
          ...
          <div className="lh-17 fw-500">
           3 Days/ 4 Nights Pokhara Tour
          </div>
          <div className="text-14 lh-15 mt-5">Pokhara, Nepal</div>
      ...
      <div className="border-top-light mt-30 mb-20" />
      <div>
        <div className="text-15">Total length of trip:</div>
        <div className="fw-500">3 days-4 nights</div>
      ...
      <div className="row y-gap-20 justify-between items-center">
        <div className="col-auto">
          ...
          <div className="fw-500">3 Days/ 4 Nights Pokhara Tour Package</div>
          <a href="#" className="text-15 text-blue-1 underline">
            Change your selection
          </a>
        </div>
        <div className="col-auto">
          <div className="text-15">4 adult</div>
        </div>
      </div>
      {/* End row */}
    </div>
