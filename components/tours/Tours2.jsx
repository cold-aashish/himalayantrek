          ...
          <SwiperSlide key={item.id}>
            ...
            >
              ...
              >
                ...
                <div className="tourCard__content  custom-card-type-1">
                  <div className="d-flex items-center lh-12 mb-5">
                    <p className="text-light-1 lh-14 text-14 mt-5">
                      <i className="icon-location-2 text-15 me-1"></i>
                      {item?.location}
                    </p>
                  </div>
                  <h4 className="tourCard__title text-dark-1 text-20 lh-12 fw-500">
                  ...
                  <div className="row justify-between items-center">
                    ...
                    <div className="col-auto">
                      <div className="text-14 fw-700">
                        <i className="icon-clock text-15 text-light-1 me-1">
                        </i>
                        {item?.days}
                      </div>
